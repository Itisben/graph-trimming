This is the c++ code for the draft paper "Efficient Parallel Graph Trimming by Arc-Consistency". The experiments test three trimming algorithms, including AC3Trim, AC4Trim, and AC6Trim.
